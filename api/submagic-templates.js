// api/submagic-templates.js
module.exports = async function handler(req, res) {
  // Basic CORS (same pattern as your other endpoints)
  ...
  try {
    ...
    // Return raw templates (or map to {name, ...} if you want)
    return res.status(200).json({ ok: true, templates: j });
  } catch (e) {
